...
computer_game_js_path=components/js/computer_game/computer_game.js
computer_game_css_path=components/css/computer_game.css
...
append_js $sc_web_path/templates/components.html $computer_game_js_path
append_css $sc_web_path/templates/components.html $computer_game_css_path
